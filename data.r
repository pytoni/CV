...
certifications <- tribble(
    ...
    "Google Data Analytics Professional Certificate", "Online", "2022", "Coursera", "This certifcate offers individuals the opportunity to gain competency in tools and platforms such as spreadsheets, SQL, Tableau, and R, enabling them to effectively prepare, process, analyze, and share data for actionable insights.",
